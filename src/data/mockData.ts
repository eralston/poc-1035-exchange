...
export const mockAccounts: Account[] = [
  ...
  // Target account for drop-ticket-1
  {
    id: 'account-3',
    dropTicketId: 'drop-ticket-1',
    accountNumber: 'PAC-ANN-NEW001',
    carrierId: 'carrier-4',
    accountType: 'annuity',
    productName: 'Pacific Life Variable Annuity',
    currentValue: 0,
    surrenderValue: 0,
    outstandingLoans: 0,
    status: 'pending',
...
export const mockDocuments: Document[] = [
  {
    ...
    originalFilename: 'Pacific Life Application - Robert Williams.pdf',
    fileSize: 2048576,
